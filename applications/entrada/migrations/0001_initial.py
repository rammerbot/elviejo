...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('b', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=5)),
                ('i', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=5)),
                ('n', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=5)),
                ('g', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=5)),
                ('o', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=5)),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
